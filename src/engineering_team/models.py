...
class ModuleSpec(BaseModel):
    ...
    name: str = Field(..., description="Name of the module (e.g., 'user_management.py')")
    ...
    interfaces: List[str] = Field(default_factory=list, description="Key methods/interfaces this module provides")
...
class SystemArchitecture(BaseModel):
    ...
    assembly_instructions: str = Field(..., description="How modules should be integrated")
...
class ModuleCreationState(BaseModel):
    ...
    def get_next_module(self) -> Optional[ModuleSpec]:
        ...
        available_modules = [
            module for module in self.architecture.modules 
